            ...
            <div class="flex flex-wrap -m-4">
                <div class="xl:w-1/4 md:w-1/2 p-4">
                    <a href="#" class="block bg-gray-100 p-6 rounded-lg">
                        ...
                        <p class="leading-relaxed text-base">カテゴリー1の説明文カテゴリー1の説明文カテゴリー1の説明文カテゴリー1の説明文カテゴリー1の説明文カテゴリー1の説明文</p>
                    </a>
                </div>
                <div class="xl:w-1/4 md:w-1/2 p-4">
                    <a href="#" class="block bg-gray-100 p-6 rounded-lg">
                        <h2 class="text-lg text-gray-900 font-medium title-font mb-4">カテゴリー2</h2>
                        <p class="leading-relaxed text-base">カテゴリー2の説明文カテゴリー2の説明文カテゴリー2の説明文カテゴリー2の説明文カテゴリー2の説明文</p>
                    </a>
                </div>
                <div class="xl:w-1/4 md:w-1/2 p-4">
                    <a href="#" class="block bg-gray-100 p-6 rounded-lg">
                        <h2 class="text-lg text-gray-900 font-medium title-font mb-4">カテゴリー3</h2>
                        <p class="leading-relaxed text-base">カテゴリー3の説明文カテゴリー3の説明文カテゴリー3の説明文カテゴリー3の説明文カテゴリー3の説明文カテゴリー3の説明文</p>
                    </a>
                </div>
                <div class="xl:w-1/4 md:w-1/2 p-4">
                    <a href="#" class="block bg-gray-100 p-6 rounded-lg">
                        <h2 class="text-lg text-gray-900 font-medium title-font mb-4">カテゴリー4</h2>
                        <p class="leading-relaxed text-base">カテゴリー4の説明文カテゴリー4の説明文カテゴリー4の説明文カテゴリー4の説明文カテゴリー4の説明文</p>
                    </a>
                </div>
            </div>
        </div>
